...
throw new Error("Module parse failed: /Users/Shared/dev/web/javascript-state-machine/src/config.js Unexpected token (171:72)\nYou may need an appropriate loader to handle this file type.\n|         if (errStr.length > 0)\n|           errStr += '\\n';\n|         errStr += 'Transition name same as state: \"' + sameAsTrans.join(, ) + '\"';\n|       }\n|       throw new Error(errStr);");
...
var mixin    = __webpack_require__(0),
    camelize = __webpack_require__(4),
    plugin   = __webpack_require__(1),
    Config   = __webpack_require__(2),
    JSM      = __webpack_require__(3);
